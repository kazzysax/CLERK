...
| Customer + merchant ★ ratings | Any fee to Clerk |
| Bayesian scores + track record | |

Merchants may still hold a little **native OKB for gas** when they sign wallet txs (register, reopen). That is **network gas**, not a product fee.
